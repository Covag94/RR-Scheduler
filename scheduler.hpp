...
struct Process {
    ...
    Process(const unsigned int pid, const unsigned int startTime, const unsigned int burstTime) {
        this->pid = pid;
...
class Scheduler {
    private:
        ...
        void updateWaitingTimes(const Process& currentProcess, const size_t runningTime) {
    ...
    public:
        ...
        void printProcess(const unsigned int pid) {
            ...
            std::cout << std::setw(12) << proc.pid
              << std::setw(12) << proc.startTime
              << std::setw(12) << proc.endTime
              << std::setw(12) << proc.burstTime
